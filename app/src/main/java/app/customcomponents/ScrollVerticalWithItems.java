...
public class ScrollVerticalWithItems extends ScrollView {
    ...
    public <T extends IHasText> void SetGroupTasks(ArrayList<T> groupTasks) {
        ...
        for (int i = 0; i < groupTasks.size(); i++) {
            ...
            taskNameTextView.setText(groupTasks.get(i).GetName());
            ...
            taskDescTextView.setText(groupTasks.get(i).GetDescription());
